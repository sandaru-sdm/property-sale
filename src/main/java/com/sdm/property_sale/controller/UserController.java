...
import com.sdm.property_sale.dto.UserStatusRequestDto;
import com.sdm.property_sale.dto.UserStatusResponseDto;
...
public class UserController {
    ...
    public ResponseEntity<UserStatusResponseDto> getUserStatusById(@PathVariable UUID userId) {
        UserStatusResponseDto userStatusDto = authService.getUserStatusDtoById(userId);
    ...
    public ResponseEntity<UserStatusResponseDto> updateStatus(@PathVariable UUID id, @Valid @RequestBody UserStatusRequestDto dto) {
        UserStatusResponseDto response = authService.updateStatus(id, dto);
